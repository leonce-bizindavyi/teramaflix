...
const LightMode = () => {
  ...
  return (
    <div className="">
      ...
      >
       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="mx-auto hover:text-slate-600 text-slate-500 w-6 h-6 md:w-9 md:h-9 lg:w-8 lg:h-8">
      ...
      <button
        ...
        onClick={() => setDarkmode(!darkmode)}
      >
       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="mx-auto text-white w-7 h-7 md:w-9 md:h-9 lg:w-8 lg:h-8">
